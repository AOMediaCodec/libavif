...
mkdir -p libxml2/build.libxml2
cmake libxml2 -B libxml2/build.libxml2/ -G Ninja -DBUILD_SHARED_LIBS=OFF -DCMAKE_INSTALL_PREFIX=libxml2/install.libxml2 \
    -DLIBXML2_WITH_PYTHON=OFF -DLIBXML2_WITH_ZLIB=OFF -DLIBXML2_WITH_LZMA=OFF
ninja -C libxml2/build.libxml2
ninja -C libxml2/build.libxml2 install
