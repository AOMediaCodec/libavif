...
TEST(ProgressiveTest, EncodeDecode) {
  ...
  testutil::AvifImagePtr image = testutil::CreateImage(512, 512, 8, AVIF_PIXEL_FORMAT_YUV444, AVIF_PLANES_YUV, AVIF_RANGE_FULL);
  ...
  ASSERT_EQ(avifEncoderAddImageProgressive(encoder.get(), layer_image_ptrs.data(), AVIF_ADD_IMAGE_FLAG_SINGLE), AVIF_RESULT_OK);
