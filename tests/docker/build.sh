...
# build env
apt update
DEBIAN_FRONTEND="noninteractive" apt install -y build-essential cargo cargo-c cmake git libjpeg-dev libpng-dev libssl-dev libyuv-dev meson nasm ninja-build perl pkg-config vim
