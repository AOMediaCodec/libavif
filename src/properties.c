...
static const struct avifKnownProperty avifKnownProperties[] = {
    { 'f', 't', 'y', 'p' }, { 'u', 'u', 'i', 'd' }, { 'm', 'e', 't', 'a' }, { 'h', 'd', 'l', 'r' }, { 'p', 'i', 't', 'm' },
    { 'd', 'i', 'n', 'f' }, { 'd', 'r', 'e', 'f' }, { 'i', 'd', 'a', 't' }, { 'i', 'l', 'o', 'c' }, { 'i', 'i', 'n', 'f' },
    { 'i', 'n', 'f', 'e' }, { 'i', 'p', 'r', 'p' }, { 'i', 'p', 'c', 'o' }, { 'a', 'v', '1', 'C' }, { 'a', 'v', '2', 'C' },
    { 'i', 's', 'p', 'e' }, { 'p', 'i', 'x', 'i' }, { 'p', 'a', 's', 'p' }, { 'c', 'o', 'l', 'r' }, { 'a', 'u', 'x', 'C' },
    { 'c', 'l', 'a', 'p' }, { 'i', 'r', 'o', 't' }, { 'i', 'm', 'i', 'r' }, { 'c', 'l', 'l', 'i' }, { 'c', 'c', 'l', 'v' },
    { 'm', 'd', 'c', 'v' }, { 'a', 'm', 'v', 'e' }, { 'r', 'e', 'v', 'e' }, { 'n', 'd', 'w', 't' }, { 'a', '1', 'o', 'p' },
    { 'l', 's', 'e', 'l' }, { 'a', '1', 'l', 'x' }, { 'c', 'm', 'i', 'n' }, { 'c', 'm', 'e', 'x' }, { 'i', 'p', 'm', 'a' },
    { 'i', 'r', 'e', 'f' }, { 'a', 'u', 'x', 'l' }, { 't', 'h', 'm', 'b' }, { 'd', 'i', 'm', 'g' }, { 'p', 'r', 'e', 'm' },
    { 'c', 'd', 's', 'c' }, { 'g', 'r', 'p', 'l' }, { 'a', 'l', 't', 'r' }, { 's', 't', 'e', 'r' }, { 'm', 'd', 'a', 't' },
};
