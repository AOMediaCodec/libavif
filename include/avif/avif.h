...
enum
{
    ...
    AVIF_COLOR_PRIMARIES_BT2020 = 9, // Same as BT2100
...
enum
{
    ...
    AVIF_TRANSFER_CHARACTERISTICS_BT709 = 1, // Same as sRGB
    ...
    AVIF_TRANSFER_CHARACTERISTICS_SMPTE2084 = 16, // PQ (BT.2100)
    AVIF_TRANSFER_CHARACTERISTICS_SMPTE428 = 17,
    AVIF_TRANSFER_CHARACTERISTICS_HLG = 18 // (BT.2100)
};
