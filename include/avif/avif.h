...
enum
{
    ...
    // BT.2100 can be achieved through AVIF_COLOR_PRIMARIES_BT2020 and
    // AVIF_TRANSFER_CHARACTERISTICS_SMPTE2084 or AVIF_TRANSFER_CHARACTERISTICS_HLG
    // with 10-bit or 12-bit samples.
};
