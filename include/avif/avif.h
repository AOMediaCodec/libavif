...
enum
{
    ...
    AVIF_COLOR_PRIMARIES_BT709 = 1, // Same as sRGB
    ...
    AVIF_COLOR_PRIMARIES_BT2020 = 9, // Same as BT.2100
...
enum
{
    ...
    AVIF_TRANSFER_CHARACTERISTICS_SMPTE2084 = 16, // Perceptual Quantizer; BT.2100 PQ
    AVIF_TRANSFER_CHARACTERISTICS_SMPTE428 = 17,
    AVIF_TRANSFER_CHARACTERISTICS_HLG = 18 // Hybrid Log-Gamma; ARIB STD-B67; BT.2100 HLG
};
