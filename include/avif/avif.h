...
enum
{
    ...
    AVIF_TRANSFER_CHARACTERISTICS_PQ = 16, // Perceptual Quantizer (HDR)
    AVIF_TRANSFER_CHARACTERISTICS_BT2100_PQ = 16,
    AVIF_TRANSFER_CHARACTERISTICS_SMPTE2084 = 16,
    AVIF_TRANSFER_CHARACTERISTICS_SMPTE428 = 17,
    AVIF_TRANSFER_CHARACTERISTICS_HLG = 18, // Hybrid Log-Gamma (HDR); ARIB STD-B67
    AVIF_TRANSFER_CHARACTERISTICS_BT2100_HLG = 18
};
