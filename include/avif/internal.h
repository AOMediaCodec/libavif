...
{
    AVIF_ENCODER_CHANGE_TILE_ROWS_LOG2 = (1 << 0),
    AVIF_ENCODER_CHANGE_TILE_COLS_LOG2 = (1 << 1),
    AVIF_ENCODER_CHANGE_QUALITY = (1 << 2),
    AVIF_ENCODER_CHANGE_QUALITY_ALPHA = (1 << 3),
    AVIF_ENCODER_CHANGE_SCALING_MODE = (1 << 4),
